/*
 *
 *   bitstrings.c    Volker Schnecke   Wed Feb 18 15:57:59 EST 1998
 * 
 *   functions:   min_int()
 *                bitstring_get_bit()
 *                bitstring_all_clear()
 ...
 *                bitstring_cmp_or_1()
 *                bitstring_cmp_xor_1()
 *                bitstring_count_bits()
 *                bitstring_cpy_all()
 *                bitstring_create()
 *                bitstring_free()
 *                bitstring_or_all()
 *                bitstring_print()
 *                bitstring_print_part()
 *                bitstring_set_all()
 *                bitstring_set_bit()
 *                bitstring_toggle_all()
 *                bitstring_toggle_bit()
 *                bitstring_xor_all()
 *
 *  routines for bitstring manipulation, based on the routines originally
 *  developed by Frank W. Lohmeyer (lohmey@informatik.uni-osnabrueck.de)
 *
 */
#include <stdio.h>
#include <stdlib.h>
