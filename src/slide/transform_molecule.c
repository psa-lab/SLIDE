/*
 * $Source: /psa/share/repository/slide/src/slide/transform_molecule.c,v $
 * $Revision: 1.9 $
 * $Author: vanvoor4 $
 * $Date: 2009/03/09 20:37:04 $
 * 
 * $Log: transform_molecule.c,v $
 * Revision 1.9  2009/03/09 20:37:04  vanvoor4
 * removed some sqrt if they didn't need to be computed, cleaned the code a bit
 *
 * Revision 1.8  2009/02/26 21:18:32  vanvoor4
 * Tidied up the code a small bit
 *
 * Revision 1.7  2007/09/28 18:33:49  toneroma
 * *** empty log message ***
 *
 */
