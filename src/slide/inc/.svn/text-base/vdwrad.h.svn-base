...
/* NOTE: changing metal values back to old slide version for testing - toneroma 2009_01_16 */
...
#define MRAD_K        2.390  /* Batsanov et al has this value as 3.0 20MAR08 toneromav.  The previous value in slide was 2.390, DOCK has the value as 1.600 */
