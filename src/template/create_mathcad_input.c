...
void create_mathcad_input(pdb_atom_pt s_atoms, int number_of_s_atoms)
{
	...
	for(i=0; i<number_of_s_atoms; i++)
	{
		if(s_atoms[i].type==UNKNOWN)
		{
			...
			if(strcmp(atom_name, " O  ") == 0) {    /* main chain O */
				...
				fprintf(outfile, "2 140 -50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 220 -50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 160  10 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 200  10 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 180  10 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 160 -10 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 200 -10 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 180 -10 %3.1f %s\n", l, output_line);
			}
			...
			if(strcmp(atom_name, " N  ") == 0) {    /* main chain N */
				...
				fprintf(outfile, "1 240 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 260 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 230  50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 250  50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 230 -50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 250 -50 %3.1f %s\n", l, output_line);
			}
			...
			if((strncmp(atom_name, " OD", 3) == 0)||
				...
				fprintf(outfile, "2 220   0 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 110  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 220  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 110 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 220 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 110  50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 220  50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 110 -50 %3.1f %s\n", l, output_line);
				fprintf(outfile, "2 220 -50 %3.1f %s\n", l, output_line);
			...
			if(strncmp(atom_name, " ND",3) == 0){
				...
				if(strcmp(res_name, "HIS") == 0){
					...
					fprintf(outfile, "3 220  25 %3.1f %s\n", l, output_line);
					fprintf(outfile, "3 240  25 %3.1f %s\n", l, output_line);
					fprintf(outfile, "3 260  25 %3.1f %s\n", l, output_line);
					fprintf(outfile, "3 220 -25 %3.1f %s\n", l, output_line);
					fprintf(outfile, "3 240 -25 %3.1f %s\n", l, output_line);
					fprintf(outfile, "3 260 -25 %3.1f %s\n", l, output_line);
				}
			...
			if(strcmp(atom_name, " OH ") == 0) {       /*  Tyr  */
				...
				fprintf(outfile, "3 110   0 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 130   0 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 230   0 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 250   0 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 110  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 130  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 230  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 250  25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 110 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 130 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 230 -25 %3.1f %s\n", l, output_line);
				fprintf(outfile, "3 250 -25 %3.1f %s\n", l, output_line);
			...
			if(strcmp(atom_name, " NZ ") == 0) {       /* Lys */
				...
				fprintf(outfile, "1 100  60 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100 180 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100 300 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100  40 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100  80 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100 280 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 100 320 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120  60 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120 180 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120 300 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120  40 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120  80 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120 280 %3.1f %s\n", l, output_line);
				fprintf(outfile, "1 120 320 %3.1f %s\n", l, output_line);
			}
